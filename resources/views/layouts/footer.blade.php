    ...
    <div id="cookie-consent" class="cookie-consent" role="dialog" aria-live="polite" aria-label="cookie consent">
        <div class="cookie-content">
            <div class="cookie-text">
                <p>We use cookies to enhance your experience on our site. <br class="desktop-break"> By continuing, you agree to our use of cookies. <a href="/privacy-policy" class="underline">Learn more</a></p>
            </div>
            <div class="cookie-actions">
                <button id="cookie-accept" class="th-btn cookie-btn">Allow cookies</button>
                <button id="cookie-reject" class="th-btn cookie-btn">Reject</button>
                <button id="cookie-close" class="th-btn btn-secondary cookie-btn">Close</button>
            </div>
        </div>
    </div>
...
<style>
    ...
    #newYearModal .ny-overlay {
        position: fixed;
        inset: 0;
        background: rgba(0, 0, 0, 0.85);
    }

    #newYearModal .ny-content {
        position: fixed;
        left: 50%;
        top: 50%;
...
<script>
    (function(){
        ...
        // Close modal on click outside image (but not on the image itself)
        if(modal) {
