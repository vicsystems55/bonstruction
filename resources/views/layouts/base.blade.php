...
<body class="">
            ...
            <div class="swiper-wrapper">
                                ...
                                <div class="col-lg-9">
                                    <div class="hero-style1">
                                        <h1 class="hero-title text-white"><span class="title1" data-ani="slideindown"
                                                data-ani-delay="0.3s">Engineering Excellence </span><span class="title2"
                                                data-ani="slideindown" data-ani-delay="0.4s">Built on
                                                Precision</span></h1>
                                        <p class="hero-text text-white" data-ani="slideinup" data-ani-delay="0.5s">
                                            ...
                                            outstanding results.</p><a href="/contact"
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-9">
                                    <div class="hero-style1">
                                        <h1 class="hero-title text-white"><span class="title1" data-ani="slideindown"
                                                data-ani-delay="0.3s">Committed to </span><span class="title2"
                                                data-ani="slideindown" data-ani-delay="0.4s">Quality & Safety</span>
                                        </h1>
                                        <p class="hero-text text-white" data-ani="slideinup" data-ani-delay="0.5s">
                ...
                <div class="swiper-slide">
                    <div class="hero-inner" data-mask-src="assets/img/hero/hero_1_bg_mask.png">
                        ...
                        <div class="hero-big-text">INNOVATION</div>
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-lg-9">
                                    <div class="hero-style1">
                                        <h1 class="hero-title text-white"><span class="title1" data-ani="slideindown"
                                                data-ani-delay="0.3s">Your Vision </span><span class="title2"
                                                data-ani="slideindown" data-ani-delay="0.4s">Our Expertise</span>
                                        </h1>
                                        <p class="hero-text text-white" data-ani="slideinup" data-ani-delay="0.5s">
                                        ...
                                        </p><a href="/contact" class="th-btn btn-mask th-btn-icon"
        ...
        <div class="container">
            <div class="row gy-40">
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        <div class="service-card-icon">
                            <div class="icon"><img src="assets/img/icon/service-icon1-1.png"
                                    alt="Main Contracting"></div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        <div class="service-card-icon">
                            <div class="icon"><img src="assets/img/icon/service-icon1-2.png"
    ...
    <section class="project-area-1 space overflow-hidden" data-bg-src="assets/img/bg/project-bg-1-1.png"
                    ...
                    <div class="col-xxl-5 col-xl-6">
                        <div class="project-title-wrap1">
                            <div class="title-area mb-40"><span class="shadow-title">PROJECTS</span>
                                <h2 class="sec-title text-white">Engineering Your Vision with Precision & Quality</h2>
                                <p class="sec-text text-white mt-15">Delivering safe, quality construction projects
                                    through innovative project management and rigorous quality assurance.</p>
                            </div>
                            <div class="btn-wrap"><a href="project" class="th-btn btn-mask th-btn-icon">Explore
                                    More</a></div>
                        </div>
                    </div>
                    <div class="col-xl-6">
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-xl-7 col-lg-8">
                    <div class="title-area text-center"><span class="shadow-title style2">Expertise</span>
                        <h2 class="sec-title">Our Core Competencies</h2>
                        <p class="sec-text text-title">We leverage strong engineering principles, rigorous project
                            management, and unwavering commitment to quality and HSE standards across all our services.
                        </p>
                    </div>
                </div>
            </div>
            <div class="swiper th-slider aminities-slider" id="aminitiesSlider1"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><a href="service-details" class="aminities-card"
                    ...
                    <div class="swiper-slide"><a href="service-details" class="aminities-card"
                            ...
                            <div class="aminities-content">
                                <div class="aminities-card-icon"><img src="assets/img/icon/aminities-icon1-6.svg"
                                        alt="contracting icon"></div>
                                <h3 class="box-title">Main Contracting</h3>
                            </div>
                        </a></div>
                </div>
                <div class="slider-pagination"></div><button data-slider-prev="#aminitiesSlider1"
                    class="slider-arrow slider-prev"><img src="assets/img/icon/arrow-left.svg"
                        alt="icon"></button>
    ...
    <section class="team-area-1 space-bottom bg-black2" id="team-sec">
        <div class="container z-index-common">
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-5 col-lg-7">
                    <div class="title-area"><span class="shadow-title">Team</span>
                        <h2 class="sec-title text-white">Our Key Personnel</h2>
                        <p class="sec-text text-white">Our experienced team is equipped with accredited certifications
                            and practical knowledge to deliver quality engineering and construction solutions.</p>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="sec-btn"><a href="team" class="th-btn btn-mask th-btn-icon">View All Members</a>
                    </div>
                </div>
            </div>
            <div class="swiper th-slider team-slider1" id="teamSlider1"
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="img-wrap">
                                <div class="team-img" data-mask-src="assets/img/theme-img/team-shape1.png"><img
                                        src="assets/img/team/team_1_1.png" alt="Team"></div>
                            </div>
                            <div class="team-card-content">
                                <div class="media">
                                    <div class="media-left">
                                        <h3 class="box-title"><a href="team-details">Chairman/CEO</a></h3><span
                                            class="team-desig">Executive Leadership</span>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="img-wrap">
                                <div class="team-img" data-mask-src="assets/img/theme-img/team-shape1.png"><img
                                        src="assets/img/team/team_1_2.png" alt="Team"></div>
                            </div>
                            <div class="team-card-content">
                                <div class="media">
                                    <div class="media-left">
                                        <h3 class="box-title"><a href="team-details">Project Coordinator</a></h3><span
                                            class="team-desig">Project Management</span>
                                    </div>
                                    <div class="media-body"><a class="icon-btn" href="tel:09876543210"><img
                                                src="assets/img/icon/phone.svg" alt="img"></a></div>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            <div class="img-wrap">
                                <div class="team-img" data-mask-src="assets/img/theme-img/team-shape1.png"><img
                                        src="assets/img/team/team_1_3.png" alt="Team"></div>
                            </div>
                            <div class="team-card-content">
                                <div class="media">
                                    <div class="media-left">
                                        <h3 class="box-title"><a href="team-details">Chief Engineer</a></h3><span
                                            class="team-desig">Civil Engineering</span>
                                    </div>
                                    <div class="media-body"><a class="icon-btn" href="tel:09876543210"><img
                                                src="assets/img/icon/phone.svg" alt="img"></a></div>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="th-team team-card">
                            ...
                            <div class="team-card-content">
                                <div class="media">
                                    <div class="media-left">
                                        <h3 class="box-title"><a href="team-details">Procurement Manager</a></h3><span
                                            class="team-desig">Procurement</span>
                                    </div>
                                    <div class="media-body"><a class="icon-btn" href="tel:09876543210"><img
                                                src="assets/img/icon/phone.svg" alt="img"></a></div>
                                </div>
                ...
                <div class="slider-pagination"></div><button data-slider-prev="#teamSlider1"
                    class="slider-arrow slider-prev"><img src="assets/img/icon/arrow-left.svg"
                        alt="icon"></button>
                <button data-slider-next="#teamSlider1" class="slider-arrow slider-next"><img
                        src="assets/img/icon/arrow-right.svg" alt="icon"></button>
            </div>
        </div>
    </section>
    <section class="space-bottom bg-black2 overflow-hidden" id="contact-sec">
        <div class="container">
            <div class="row gy-80 gx-40 align-items-center">
                <div class="col-xl-6">
                    <div class="cta-thumb img-shine" data-mask-src="assets/img/shape/cta_1_1-img-mask.png"><img
                            class="w-100" src="assets/img/normal/cta_1_1.png" alt="img"></div>
                </div>
                <div class="col-xl-6">
                        ...
                        <div class="call-btn style3">
                            ...
                            <div class="btn-content">
                                <h6 class="btn-title">Call Us Anytime:</h6><span class="btn-text"><a
                                        href="tel:2348168445981">+234 816 844 5981</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row gy-80 flex-row-reverse">
                <div class="col-xl-5">
                    <div class="testi-thumb-wrap">
                        <div class="img1"><img src="assets/img/testimonial/testi_thumb_1_1.png" alt="img">
                        </div>
                        <div class="img2 jump"><img src="assets/img/testimonial/testi_thumb_1_2.png" alt="img">
                        </div>
                    </div>
                </div>
                <div class="col-xl-7">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testi-card">
                                    ...
                                    <p class="testi-card_text">"Bonstruction Engineering delivered our industrial
                                        facility ahead of schedule while maintaining the highest quality standards.
                                        Their project management team ensured seamless coordination across all trades."
                                    </p>
                                        ...
                                        <div class="testi-card_profile">
                                            ...
                                            <div class="testi-card_profile-details">
                                                <h3 class="testi-card_name">Adebayo Johnson</h3><span
                                                    class="testi-card_desig">Operations Director, Lagos Industrial
                                                    Park</span>
                                            </div>
                                        </div>
                                        <div class="quote-icon"><img src="assets/img/icon/qoute.svg" alt="icon">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testi-card">
                                    <div class="testi-grid_review"><i class="fa-sharp fa-solid fa-star"></i><i
                                            ...
                                            class="fa-sharp fa-solid fa-star"></i><i
                                            class="fa-sharp fa-solid fa-star"></i></div>
                                    <p class="testi-card_text">"Their commitment to HSE standards is exceptional. The
                                        zero-incident record on our oil and gas project demonstrated their
                                        professionalism and attention to safety protocols."</p>
                                    <div class="testi-grid-wrap">
                                        <div class="testi-card_profile">
                                            <div class="avatar" data-mask-src="assets/img/shape/testi_1_1-mask.png">
                                            ...
                                            <div class="testi-card_profile-details">
                                                <h3 class="testi-card_name">Chiamaka Okoro</h3><span
                                                    class="testi-card_desig">Project Manager, Delta Energy</span>
                                            </div>
                                        </div>
                                        <div class="quote-icon"><img src="assets/img/icon/qoute.svg" alt="icon">
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testi-card">
                                    <div class="testi-grid_review"><i class="fa-sharp fa-solid fa-star"></i><i
                                            ...
                                            class="fa-sharp fa-solid fa-star"></i><i
                                            class="fa-sharp fa-solid fa-star"></i></div>
                                    <p class="testi-card_text">"The engineering solutions provided were innovative and
                                        cost-effective. Bonstruction's ability to handle both design and execution made
                                        our commercial complex project remarkably smooth."</p>
                                    <div class="testi-grid-wrap">
                                        <div class="testi-card_profile">
                                            <div class="avatar" data-mask-src="assets/img/shape/testi_1_1-mask.png">
                                            ...
                                            <div class="testi-card_profile-details">
                                                <h3 class="testi-card_name">David Chen</h3><span
                                                    class="testi-card_desig">International Development Partner</span>
                                            </div>
                                        </div>
                                        <div class="quote-icon"><img src="assets/img/icon/qoute.svg" alt="icon">
                                        </div>
            ...
            <div class="row gx-40">
                <div class="col-xxl-6 col-lg-7 align-self-center">
                    <div class="space-bottom text-lg-start text-center">
                        <div class="title-area mb-30"><span class="shadow-title">Applicaton</span>
                            <h2 class="sec-title text-white">Do you want to get Estimation? Download App</h2>
                        ...
                        <div class="btn-wrap justify-content-lg-start justify-content-center"><a href="/contact"
                                class="th-btn btn-mask th-btn-icon">Download App</a></div>
                    </div>
                </div>
                <div class="col-xxl-6 col-lg-5 align-self-end">
                    <div class="download-thumb text-center"><img src="assets/img/normal/download_1_1.png"
                            alt="img">
                    </div>
                </div>
            </div>
...
<section class="space bg-black2 d-non" id="blog-sec">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-5 col-lg-7">
                    <div class="title-area"><span class="shadow-title">Insights</span>
                        <h2 class="sec-title text-white">Industry Insights & Updates</h2>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="sec-btn"><a href="blog" class="th-btn btn-mask th-btn-icon">Browse All
                            Insights</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="blog-bottom-wrap">
                        <div class="blog-author-wrap">
                            <div class="avatar"><img src="assets/img/blog/avatar_1.png" alt=""></div><a
                                href="blog">By Quality Manager</a>
                        </div>
                        <div class="blog-date">April 12, 2025</div><a href="blog-details"
                            class="th-btn btn-mask2 th-btn-icon">Read More</a>
                    </div>
                </div>
            </div>
            <div class="blog-grid">
                    ...
                    <div class="blog-bottom-wrap">
                        <div class="blog-author-wrap">
                            <div class="avatar"><img src="assets/img/blog/avatar_2.png" alt=""></div><a
                                href="blog">By HSE Coordinator</a>
                        </div>
                        <div class="blog-date">March 16, 2025</div><a href="blog-details"
                            class="th-btn btn-mask2 th-btn-icon">Read More</a>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="checklist">
                                        <ul>
                                            ...
                                            <li class="text-light"><strong>Avenue End Date:</strong> 22 July, 2025
                                            </li>
                                            <li class="text-light"><strong>Locations:</strong> NewYork - 2546 Firs,
                                                USA
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="checklist">
                                        <ul>
                                            ...
                                            <li class="text-light"><strong>Avenue End Date:</strong> 22 July, 2023
                                            </li>
                                            <li class="text-light"><strong>Locations:</strong> NewYork - 2546 Firs,
                                                USA
                                            </li>
